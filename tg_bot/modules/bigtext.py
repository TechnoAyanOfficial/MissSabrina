...
__help__ = """
 *Originally Made By* [AyanAnsari](T.me/TechnoAyanOfficial)
 
 - /bigt <text>: Convert Your Text To Big Text
 
 """

WEEBIFY_HANDLER = DisableAbleCommandHandler("bigt", weebify, pass_args=True)
