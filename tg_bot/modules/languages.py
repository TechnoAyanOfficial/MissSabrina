...
from tg_bot import dispatcher, spamfilters, LOGGER
from tg_bot.modules.disable import DisableAbleCommandHandler
from tg_bot.modules.helper_funcs.chat_status import user_admin_no_reply, user_admin

from tg_bot.modules.sql import languages_sql as sql
...
for x in os.listdir('tg_bot/modules/langs'):
	...
	imported_langs = importlib.import_module("tg_bot.modules.langs." + x)
